...
The connect code is generated by 开工吧 after the user approves OpenClaw or another external Agent. The npx command installs the skill into `${CODEX_HOME:-~/.codex}/skills/kaigongba-agent-connect` and writes:
